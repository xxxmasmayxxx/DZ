...
function uploadFiles($files, $maxFileSize = 2048)
{
    ...
    foreach ($files as $f1) {
        ...
        if (!empty($fileUploadErr)) {
            ...
            echo '<a class="news" href="#" onclick="location.href = document.referrer; return false;">Get back</a>'.PHP_EOL;
...
function displayGallery1()
{
    ...
    if (!empty($imageFiles)) {
        ...
        foreach ($imageFiles as $file) {
            ...
            $galleryHtml .= '<div class="col-sm-6 col-md-4">
      <img src="' . $pathToFilesWeb . $imgName . '" width="250" alt="" />
    </div>';
        }
